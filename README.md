...
- **Teia**: riceve snapshot (`frame_available`) dal data channel WebRTC `cmd`, scarica il file, lo invia a una API LLM e pubblica sullo stesso data channel una descrizione testuale (`snapshot_description`).
